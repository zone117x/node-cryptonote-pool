...
function runInterval() {
    async.waterfall(
        [
            getWorkerKeys,
	    getWorkerBalances,
	    filterBalancesAbovePaymentThreshold,
	    prepareTransferCommands,
	    doTransferCommands
        ], 
...
var getWorkerKeys = function(callback) {
...
var getWorkerBalances = function(keys, callback){
...
var filterBalancesAbovePaymentThreshold = function(balances, callback){
    var payments = {};
...
var prepareTransferCommands = function(payments, callback) {
    ...
    callback(null, transferCommands);
};

var doTransferCommands = function(transferCommands, callback) {
    var timeOffset = 0;
