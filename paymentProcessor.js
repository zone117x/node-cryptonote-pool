    ...
    async.waterfall([
        ...
        function(blocks, callback){
            ...
            if (blocksToProcess.length === 0){
                log('debug', 'No pending blocks are unlocked or orphaned yet');
                callback(true);
                return;
            }
            ...
            //if (block.orphan){
            //    redisCommands.push(['smove', config.coin + ':blocksPending', config.coin + ':blocksOrphaned', block.serialized]);
            //}
        ...
        function(blocks, callback){
            ...
            blocks.forEach(function(block){
                ...
                var workerShares = blocks.workerShares;
        ...
        function(blocks, callback){
            ...
            for (var worker in payments){
                transferData.destinations.push({amount: payments[worker], address: worker});
            }
