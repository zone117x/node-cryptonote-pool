...
function spawnPoolWorkers () {
  ...
  var numForks = (function () {
    if (!config.poolServer.clusterForks) { return 1 }
    if (config.poolServer.clusterForks === 'auto') { return os.cpus().length }
    if (isNaN(config.poolServer.clusterForks)) { return 1 }
